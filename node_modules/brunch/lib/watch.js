  ...
  BrunchWatcher = (function() {
    function BrunchWatcher(persistent, options, onCompile) {
      ...
      initialize(options, configParams, onCompile, function(error, result) {
        var compile, compilers, fileList, includes, linters, reload, watcher, _ref;
        if (error != null) {
          return logger.error(error);
        }
        ...
        logger.notifications = _this.config.notifications;
        logger.notificationsTitle = _this.config.notificationsTitle || 'Brunch';
